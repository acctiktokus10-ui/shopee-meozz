      ...
      <div style={{ maxWidth: "500px", margin: "18px auto 0", padding: "0 16px" }}>
        ...
        <div style={{
          ...
          {[
            ...
            <button
              ...
              style={{
                flex: 1, padding: "6px 0", border: "none", borderRadius: "50px",
                cursor: "pointer", fontFamily: "inherit", fontWeight: "700", fontSize: "8px",
                transition: "all 0.2s",
            ...
            <div style={{
              ...
              <div style={{ position: "relative" }}>
                ...
                <input
                  ...
                  style={{
                    width: "100%", padding: "7px 25px 7px 22px", borderRadius: "14px",
                    border: "1.5px solid #eee", fontSize: "7px", background: "#fafafa",
              ...
              <button
                ...
                disabled={loading}
                style={{
                  width: "100%", marginTop: "7px", padding: "9px", border: "none",
                  borderRadius: "16px",
              ...
              <p style={{ textAlign: "center", color: "#bbb", fontSize: "6px", marginTop: "5px", marginBottom: 0 }}>
              ...
              <>
                {result.success ? (
                  <div style={{
                    ...
                    <div style={{ color: "#22863a", fontSize: "8px", fontWeight: "800", display: "flex", alignItems: "center", gap: "8px" }}>
                      <CheckCircleIcon size={22} color="#22863a" />
                      Đã chuyển đổi xong
                    </div>
                    <div style={{ marginTop: "6px", fontSize: "6px", color: "#444", wordBreak: "break-all", lineHeight: 1.6 }}>
                      {result.affiliateLink
                        ? (result.affiliateLink.includes("s.shopee.vn")
                            ? "http://s.shopee.vn/..."
                            : result.affiliateLink.replace(/^(https?:\/\/[^/]+).*$/, "$1/..."))
                        : ""}
                    </div>
                    <div style={{ display: "flex", gap: "6px", marginTop: "8px" }}>
                      ...
                      <button
                        onClick={handleCopy}
                        style={{
                          flex: 1, padding: "7px 0", border: "none", borderRadius: "10px",
                  ...
                  <div style={{
                    ...
                    color: "#c53030", fontSize: "8px", fontWeight: "700",
                  }}>
                    ❌ {result.error}
                  </div>
                )}
                ...
                <div style={{
                  ...
                  background: "#fff8fb", color: "#555", lineHeight: "1.7", fontSize: "7px",
                }}>
                ...
                >
                  <span style={{ color: "#b7791f", fontWeight: "700", fontSize: "7px" }}>
                    💡 <u>Mẹo săn Voucher 20-25% Shopee × Facebook</u>
                  </span>
                  <span style={{ color: "#b7791f", fontSize: "9px", transition: "transform 0.2s", display: "inline-block", transform: tipOpen ? "rotate(180deg)" : "rotate(0deg)" }}>▾</span>
                </div>
                {tipOpen && (
                  <div style={{
                    background: "#fffef0", border: "1.5px solid #ffe58f",
                    borderTop: "none", borderRadius: "0 0 16px 16px",
                    padding: "16px 20px", fontSize: "7px", color: "#555", lineHeight: 1.8,
                  }}>
        ...
        {activeTab === "voucher" && (
          <div style={{ marginTop: "18px" }}>
            <p style={{ textAlign: "center", color: "#888", fontSize: "7px", marginBottom: "16px" }}>
  ...
  return (
    ...
    >
      ...
      <div style={{
        ...
        <span style={{ fontWeight: "800", fontSize: "6px", letterSpacing: "0.3px" }}>{voucher.platform}</span>
      </div>
      ...
      <div style={{ flex: 1, padding: "12px 12px 10px" }}>
        <div style={{ fontSize: "7px", fontWeight: "800", color: "#ff5a00", lineHeight: 1.3 }}>{voucher.discount}</div>
        <div style={{ fontSize: "5px", color: "#666", marginTop: "3px" }}>{voucher.minOrder}</div>
        <div style={{
        ...
        {voucher.usedPercent !== null ? (
          <div style={{ marginTop: "8px" }}>
            ...
            <div style={{ fontSize: "5px", color: "#aaa", marginTop: "3px" }}>
              Đã dùng {voucher.usedPercent}% · hết hạn trong: ...
            </div>
          </div>
        ) : (
          <div style={{ marginTop: "8px", fontSize: "5px", color: "#aaa" }}>
      ...
      {!selectable && (
        <div style={{ display: "flex", alignItems: "center", paddingRight: "12px" }}>
          <div style={{
            ...
            fontSize: "5px", fontWeight: "700", textAlign: "center",
